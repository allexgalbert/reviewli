<p align="center">
<img src="https://raw.githubusercontent.com/allexgalbert/reviewli/main/DOC/full.png" width="400">
</p>

# Reviewli CMS

- Быстрая и простая CMS с открытым исходным кодом
- Немного похожа на Tripadvisor
...
```sh
composer create-project --stability=dev allexgalbert/reviewli
composer install
npm install
```
...
![Reviewli CMS](https://raw.githubusercontent.com/allexgalbert/reviewli/main/DOC/1.png "Reviewli CMS")